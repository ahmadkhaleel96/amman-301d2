...
function displayPics(){
  ...
  // Because const is a block scoped element so it is only defined within the same scope. so when we consoled log the variable it gives an error. as for const the errors occured for assigning the values for declared constants.
  console.log(viewed);
