...
function Product(name) {
  ...
  this.votes = 0;
  this.views = 0;
  allProducts.push(this);'use strict';
...
function displayPics(){
  ...
  // because the let is hoisted in its same block so the rando value is only within the function it's self.
  // in the const it assings a fixed value that can't be changed to a variable and within for loops.
  console.log(viewed);
